      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-zinc-900/40 backdrop-blur-sm border border-zinc-800 rounded-xl overflow-hidden relative">
          ...
          <div className="p-8">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <h2 className="text-3xl font-bold text-white flex items-center gap-3">
                  Тариф PRO 
                  <span className="text-xs font-bold px-2 py-1 bg-electric-500 text-white rounded uppercase tracking-wide">Активен</span>
                </h2>
              </div>
              <div className="text-right">
                <p className="text-2xl font-bold text-white">4900₽<span className="text-lg text-zinc-500 font-normal">/мес</span></p>
                <p className="text-xs text-zinc-500">Следующее списание: 24 Окт</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <button className="px-6 py-2.5 bg-white text-black font-medium rounded-lg hover:bg-zinc-200 transition-colors">
                Управление подпиской
              </button>
              <button className="px-6 py-2.5 bg-transparent border border-zinc-700 text-zinc-300 font-medium rounded-lg hover:bg-zinc-800 transition-colors">
                Сменить тариф
              </button>
            </div>
          </div>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-zinc-900/40 backdrop-blur-sm border border-zinc-800 rounded-xl p-6">
            ...
            <button className="w-full py-2 text-sm text-zinc-400 hover:text-white border border-dashed border-zinc-700 rounded-lg hover:border-zinc-500 transition-all">
              + Добавить карту
            </button>
          </div>
          ...
          <div className="bg-zinc-900/40 backdrop-blur-sm border border-zinc-800 rounded-xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="h-1.5 w-full bg-zinc-800 rounded-full overflow-hidden">
                  <div className="h-full bg-purple-500 w-1/5 rounded-full"></div>
                </div>
              </div>
            </div>
          </div>
