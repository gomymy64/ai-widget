                    ...
                    <div className="flex items-end p-2 gap-2">
                        ...
                        <div className="flex items-center gap-1 pb-1 pr-1">
                            ...
                            className={`p-2.5 rounded-full transition-all duration-200 flex items-center justify-center ${
                                (wizardInput.trim() || wizardFiles.length > 0)
            ...
            <div className="w-full h-full bg-zinc-950 flex flex-col">
              ...
              <div ref={chatContainerRef} className="flex-1 p-4 overflow-y-auto space-y-4 scroll-smooth">
                 ...
                 {previewMessages.map((msg) => {
                    ...
                    return (
                        <div key={msg.id} className={`flex ${isUser ? 'justify-end' : 'justify-start'} animate-in fade-in zoom-in-95 duration-200`}>
                            <div className={`px-4 py-2.5 max-w-[85%] text-[13px] leading-snug ${isUser ? 'bg-indigo-600 text-white rounded-2xl rounded-tr-sm' : 'bg-zinc-800 text-zinc-200 rounded-2xl rounded-tl-sm'}`}>
                              {msg.text}
                            </div>
                        </div>
                    );
